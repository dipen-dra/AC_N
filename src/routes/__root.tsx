...
export const Route = createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      { title: "AutoCare Nepal — Trusted Car Service, Booking & Tracking" },
      { name: "description", content: "Book, track and manage vehicle servicing across Nepal. Pickup & drop, live tracking, secure payments and 24/7 support." },
      { name: "author", content: "AutoCare Nepal" },
      { property: "og:title", content: "AutoCare Nepal — Trusted Car Service" },
      { property: "og:description", content: "Book, track and manage vehicle servicing across Nepal." },
